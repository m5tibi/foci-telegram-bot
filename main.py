    ...
    try:
        ...
        for match_data in matches_today:
            if match_data['league']['id'] in ERDEKES_LIGAK:
                ...
                # --- EZ AZ ÚJ, BIZTONSÁGOS LOGIKA ---
                # A sorokat egyenként adjuk hozzá a táblázatokhoz.
                ...
                if tip_1x2 != "N/A":
                    archivum_sheet.append_row([match_id, fixture['date'], meccs_neve, '1X2', tip_1x2, '', 'Függőben'], value_input_option='USER_ENTERED')
                if tip_goals != "N/A (keves adat)":
                    archivum_sheet.append_row([match_id, fixture['date'], meccs_neve, 'Gólok O/U 2.5', tip_goals, '', 'Függőben'], value_input_option='USER_ENTERED')
                if tip_btts != "N/A (keves adat)":
                    archivum_sheet.append_row([match_id, fixture['date'], meccs_neve, 'BTTS', tip_btts, '', 'Függőben'], value_input_option='USER_ENTERED')
