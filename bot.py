...
async def admin_broadcast_message_handler(update: telegram.Update, context: CallbackContext):
    ...
    try:
        ...
        if not response.data: await update.message.reply_text("Nincsenek aktív felhasználók."); return
...
def add_handlers(application: Application):
    broadcast_conv_handler = ConversationHandler(
        ...
        states={
            AWAITING_BROADCAST: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin_broadcast_message_handler)]
        },
