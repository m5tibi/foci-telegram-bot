...
async def start(update: telegram.Update, context: CallbackContext):
    ...
    try:
        ...
        if is_active:
            ...
            reply_markup = InlineKeyboardMarkup(keyboard)
            await message.edit_text("Szia! Ez a Mondom a Tutit! botja.\nA tippek eléréséhez és az előfizetéshez kérlek, látogass el a weboldalunkra:", reply_markup=reply_markup)
    except Exception as e:
