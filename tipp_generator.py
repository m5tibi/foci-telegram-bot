...
def main():
    ...
    print(f"Tipp Generátor (V7.0) indítása {'TESZT ÜZEMMÓDBAN' if is_test_mode else ''}...")
    ...
    if all_slips:
        ...
        reason = "A holnapi kínálatból a V7.0 Hibrid algoritmus nem talált a kritériumoknak megfelelő, kellő értékkel bíró tippeket."
        print(reason)
        if is_test_mode:
