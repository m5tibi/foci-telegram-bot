# tipp_generator.py (V18.2 - Javított Teszt Kiíratás)
...
def main(run_as_test=False):
    ...
    print(f"🚀 Multi-Sport Tipp Generátor (V18.2) indítása ({target_date_str})...")
    ...
    # 2. LÉPÉS: HA KEVÉS A TIPP -> HOKI & KOSÁR
